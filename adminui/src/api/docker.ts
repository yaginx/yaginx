...
export const websiteDelete = (data: any): Promise<IApiRspEnvelop<any>> => FetchJson({ url: '/api/website/delete', method: 'DELETE', data });
...
export const webDomainDelete = (data: any): Promise<IApiRspEnvelop<any>> => FetchJson({ url: '/api/web_domain/delete', method: 'DELETE', data });
