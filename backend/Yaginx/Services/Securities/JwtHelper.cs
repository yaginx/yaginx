...
namespace Yaginx.Services.Securities
{
    ...
    {
        public static async Task<(long expiresIn, string token)> GenerateToken(DateTime issued, TimeSpan expiration, TokenSettings tokenSettings, Action<List<Claim>> claimHandler = null)
        {
